...
def avanzar_estado(
    ...
    return service.cambiar_estado(uow, pedido_id, payload.nuevo_estado, current_user, payload.motivo)
...
def cancelar_pedido(
    ...
    return service.cambiar_estado(uow, pedido_id, "CANCELADO", current_user, payload.motivo)
